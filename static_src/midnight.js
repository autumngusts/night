...
(function () {
  ...
  // button是grantLootRewardEntryToCharacter()給的weaponSkillReroll點數唯一的消費入口。
  // 2026-09-08使用者明確規格「不放在腳色視窗內，在離開鍛造村範圍後直接歸0無法使用」：
  // 額外只在nearbySmithingVillage（見updateNearbyFieldPoint()）非null時才顯示。
  ...
  function renderCombatPanel() {
    ...
    var showEnemyHpValue = !!(meta && (meta.testMode || meta.debugMode));
