...
BODY = """    <div class="night-header-row">
    ...
    <section id="screen-board" class="screen">
      ...
      <div id="location-status-overlay" hidden>
        ...
        <button type="button" id="btn-location-status-toggle" aria-label="toggle floor banner (long-press while collapsed to move corner)"></button>
      </div>
      ...
      <div id="spirit-panel-modal" class="modal" hidden>
        <div class="modal-box combat-modal-box">
    ...
    <div id="rulebook-modal" class="modal" hidden>
      <div class="modal-box gallery-modal-box rulebook-modal-box">
        ...
        <div class="rulebook-tab-panel" id="rulebook-panel-consumable" hidden>
          <div id="consumable-determine-table"></div>
    ...
    <button id="btn-dice-hand-draw-restore" type="button" class="potential-power-restore-btn dice-hand-draw-restore-btn" data-i18n="dice_hand_draw_restore_button" hidden></button>
